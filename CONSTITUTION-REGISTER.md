...
Every rule on the target list has a row, and three policies of the origin were added on 20 September 2026 (`OBL-C-0015` to `0017`). Five witness cells say `open`: the 1 MB narrowing against
