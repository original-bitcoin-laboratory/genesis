...
13 January 2009. There is no public v0.1.1 or v0.1.2 — the archived jump is 0.1.0 → 0.1.3, and the
Satoshi Nakamoto Institute marks even the 0.1.3 date with a question mark.
