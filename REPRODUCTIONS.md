...
- **The base.** The two January 2009 archives are committed under `artifacts/jan09/`, verified against the published
  digests before use, so the foundation of every `JAN09-SOURCE` row is reachable from the repository.
